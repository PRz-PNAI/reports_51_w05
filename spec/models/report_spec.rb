describe Report do
  ...
  it { is_expected.not_to allow_values("asd", "asd.pl", "@asd.pl", "asd@asd","asd@fgh@sfd.pl", "dsa@.com.pl").for(:email) }
  it { is_expected.to allow_values("asd@asd.pl", "asd@asd.com", "dsa@ad.com.pl", "asd.ewq@qwe.gov").for(:email) }
